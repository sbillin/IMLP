...
workingDir = './RandomTestData_PointCloud_SubShape';
outputFolder = [];
% workingDir = '.';
% outputFolder = [];
...
noiseEigValSqrt1 =   {'0','0.5','1','1','0.5','0.5','0.5'};
noiseEigValSqrt23 =  {'0','0.5','1','0.5','1','1','1'};
noiseType = {
...
cmpAlgIndex = 5;  % compare other trials to IMLP
