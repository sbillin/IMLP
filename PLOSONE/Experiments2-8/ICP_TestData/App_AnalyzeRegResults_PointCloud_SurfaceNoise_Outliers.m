...
workingDir = './RandomTestData_PointCloud_SurfaceNoise_Outliers';
outputFolder = [];
% workingDir = '.';
% outputFolder = [];
...
algOutlierSubNames = {
  ...
  repmat({'_d1000'},1,size(outliers,2))
  repmat({''},1,size(outliers,2))
  repmat({'_SamplesY'},1,size(outliers,2))
  {'_ChiSqu7.81','_ChiSqu6.25','_ChiSqu4.64','_ChiSqu3.66','_ChiSqu3.66'}
  };
