#ifndef _mexInterface_AlgDirICP_GIMLOP_Mesh_h
#define _mexInterface_AlgDirICP_GIMLOP_Mesh_h
...
class mexInterface_AlgDirICP_GIMLOP_Mesh
{
...
public:
  ...
  // constructor
	mexInterface_AlgDirICP_GIMLOP_Mesh() 
    : pAlg(NULL)
  {}
