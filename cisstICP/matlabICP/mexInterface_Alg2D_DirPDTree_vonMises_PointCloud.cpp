// ****************************************************************************
//
//  $Id: mexInterface_Alg2D_DirPDTree_vonMises_PointCloud.cpp, v0.1 Exp $
//
//  Description:
//	        
//
...
#include "mexInterface_Alg2D_DirPDTree_vonMises_PointCloud.h"
...
{ // create new class instance
  ...
  plhs[0] = convertPtr2Mat < mexInterface_Alg2D_DirPDTree_vonMises_PointCloud >
    (new mexInterface_Alg2D_DirPDTree_vonMises_PointCloud);
}
...
{ // delete class instance
  ...
  destroyObject<mexInterface_Alg2D_DirPDTree_vonMises_PointCloud>(prhs[1]);
}
...
void CommandInitialize(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
  ...
  //  cmd
  //  class handle
  //  points                ~ 2D model shape points
  //  pointsOrientations    ~ 2D model shape point orientations
  //

  std::stringstream ss;

  // Get the class instance from the second input
  mexInterface_Alg2D_DirPDTree_vonMises_PointCloud& obj =
    *convertMat2Ptr<mexInterface_Alg2D_DirPDTree_vonMises_PointCloud>(prhs[1]);

  // Check parameters
  if (nlhs != 0 || nrhs != 4)
  {
    MEX_ERROR("Cmd Initialize: requires 0 outputs, 4 inputs.");
  }
  ...
  MEX_DEBUG(" ...point orientations\n");
  Parse2DVectorArray_Double(prhs[3], obj.pointOrientations);
  ...
  obj.pDirTree = new DirPDTree2D_PointCloud(
    cisstPointCloud2D(obj.points, obj.pointOrientations),
  ...
  obj.pAlg = new alg2D_DirPDTree_vonMises_PointCloud(obj.pDirTree);
...
void CommandComputeMatches(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
  ...
  alg2D_DirPDTree_vonMises_PointCloud &alg = *obj.pAlg;
...
void mexInterface_Alg2D_DirPDTree_vonMises_PointCloud::ComputeMatches()
{
