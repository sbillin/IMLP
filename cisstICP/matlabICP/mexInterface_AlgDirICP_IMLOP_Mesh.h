#ifndef _mexInterface_AlgDirICP_IMLOP_Mesh_h
#define _mexInterface_AlgDirICP_IMLOP_Mesh_h
...
class mexInterface_AlgDirICP_IMLOP_Mesh
{
...
public:
  ...
  // constructor
	mexInterface_AlgDirICP_IMLOP_Mesh() 
    : pAlg(NULL)
  {}
